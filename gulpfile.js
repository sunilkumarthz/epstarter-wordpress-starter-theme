...
gulp.task('jscripts', ['copy'], function () {
    var scripts = [
        paths.dev + '/js/functions/*.js',
        paths.dev + '/js/app.js'
    ];
    gulp.src(scripts)
...
gulp.task('copy', function () {
    return gulp.src(['src/js/vendor/*.js', 'src/js/vendor/**/*.js', 'src/js/bootstrap4/bootstrap.bundle.min.js'])
...
/**
 * This task is used for developer 
 * watching file changes
 * Output unminified file
 * @Command gulp watch 
 */
gulp.task('watch', ['clean', 'browser-sync', 'jscripts', 'sass'], function () {
});